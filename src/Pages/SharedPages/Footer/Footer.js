            ...
            <footer className="footer p-10 text-white max-w-6xl mx-auto lg:ml-24">
                <div>
                    <Link className="normal-case px-2 flex items-center">
                        ...
                        <span className='font-bold text-black text-4xl ml-2 mt-1'>Medico</span>
                    </Link>
                    <p>Medico is a online medicine shop. We are focused on getting your <br /> necessary medicine & giving you great healthcare support.<br />Find your required medicine at Medico.</p>
                ...
                <div>
                    <span className="footer-title text-black">Online Medicine Shop</span>
                    <Link to='/'>Home</Link>
                ...
                <div>
                    ...
                    <div className="grid grid-flow-col gap-4">
                        <Link><MdEmail size={26} /></Link>
                        <Link><FaTwitter size={26} /></Link>
